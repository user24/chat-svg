...
export default function Chat () {
  ...
  const handleSubmit = async (e:FormEvent<HTMLFormElement>) => {
    ...
    console.log('Raw ChatGPT output:');
    data.answers.forEach((answer:string, i:number) => console.log(`answer ${i}`, answer));
    const svgs = extractSvgContents(data.answers.join(' '), `${upperFirst(topic)}. Generated by ChatSVG.`);
    setLoading(false);
    setResult(svgs);
  };
